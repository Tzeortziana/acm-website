    ...
    <footer id="contact" className="bg-slate-950 text-white pt-12 pb-8 border-t border-slate-900">
      <div className="max-w-[95%] mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 mb-12">
          ...
          {/* Column 2 - links */}
          <div>
            <h4 className="font-bold text-lg mb-5 text-slate-100">
          ...
          <div>
            ...
            <div className="flex space-x-4">
              <a href="https://www.instagram.com/acmuoc/" className="w-12 h-12 bg-slate-900 rounded-xl flex items-center justify-center hover:bg-blue-600 transition-all group shadow-md">
